...
sal_terra = media.Movie("O Sal da Terra",
	u"O fotógrafo brasileiro Sebastião Salgado viaja a 40 anos através dos continentes aos passos de uma humanidade sempre em mutação. O filme retrata esta história. Uma homenagem à beleza do planeta.",
...
ensaio_cegueira = media.Movie("Ensaio sobre a Cegueira",
	u"Filme baseado no livro de mesmo nome do autor português José Saramago.",
	...
	"https://www.youtube.com/watch?v=AyYZA7bLsYA")

sobral_pinto = media.Movie(u"Sobral: O Homem que não tinha Preço",
	u"Documentário sobre a história da vida de um dos mais emblemáticos advogados brasileiros Sobral Pinto.",
